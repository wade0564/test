...
public enum LOG_FILE_TYPE {
	...
	ASUP("autosupport"), SUB("tar.gz||tgz"), KERN_INFO("kern.info"), KERN_ERROR("kernel.info"), MESSAGES_ENGINEERING("messages.engineering"), VTL_INFO("vtl.info"), BIOS("bios.txt"), UNKONWN(".*");
	...
	public static List<LOG_FILE_TYPE> getFileTypeInSub(){
		return Arrays.asList(ASUP,KERN_INFO,MESSAGES_ENGINEERING,VTL_INFO,BIOS);
	}
